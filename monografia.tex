...
\titulo{Clustering de imagens via redes neurais de Kohonen associadas a momentos invariantes de Hu}
...
\include{introducao}
\include{descritores_de_imagens}
\include{rotulacao_das_imagens}
\include{resultados}
\include{conclusoes}
